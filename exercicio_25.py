...
# numeros = input("Entre com uma lista de numeros separados por vírgula --> ")

# try:
#     lista_numeros_separados = numeros.split(",")
#     print(lista_numeros_separados)

# except ValueError(int):
#     print("Erro: Número não inteiro")
